        ...
        <div className='rooms-list '>
          ...
          <PasscodeModal chatroom={chatroom} show={show2} close={closeModalHandler2} submit={submit}/>
                ...
                <div className=' text-color-pink'>
                        ...
                        <div onClick={() => {closeModalHandler2(true); setRemove(false); !room.access.includes(localUserInfo.user_id) ? (room.passcode === '' ? setShow2(false) : setShow2(true)) : setShow2(false) }}>{room.name} 
